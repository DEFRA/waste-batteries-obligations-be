using WasteBatteriesObligationsBe.Example.Endpoints;
using WasteBatteriesObligationsBe.Example.Services;
using WasteBatteriesObligationsBe.ExampleData.Endpoints;
using WasteBatteriesObligationsBe.ExampleData.Services;
using WasteBatteriesObligationsBe.Config;
using WasteBatteriesObligationsBe.Utils;
using WasteBatteriesObligationsBe.Utils.Http;
using WasteBatteriesObligationsBe.Utils.Mongo;
using System.Diagnostics.CodeAnalysis;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using WasteBatteriesObligationsBe.Utils.Logging;
